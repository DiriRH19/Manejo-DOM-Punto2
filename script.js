async function sendToGemini() {
            ...
            let respuesta = inputText;
            if(inputText.trim().toLowerCase()==='enviar un mensaje al discord'){
                 loader.style.display = 'none';
                responseContainer.textContent = "Mensaje Enviado al Discord";
                 Swal.fire({
                    text:"Mensaje Enviado al Discord"
                });
                return;
            }
